...
- [x] Prompt geometry рендериться XML-подібними тегами або рівноцінними чіткими секціями; `telegram_chat_system.md` пояснює різницю між `long_memory`, `short_memory` і `current_user_message`. — 2026-05-24, `render_chat_prompt(...)`, `prompts/telegram_chat_system.md`.
