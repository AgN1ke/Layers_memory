...
- [ ] Автоматична маршрутизація validation тільки для high-weight/high-risk/Core-path units, не всієї рутини. Поки є manual/debug шлях `/fidelity <memory_unit_id>`.
